...
1.  **Stitching pairs of images .** We will estimate homography 
    ...
    **Test Images:** We are providing a image pairs that you should stitch 
    ...
    1.  **Putative Matches.** Select putative matches based on the matrix
    ...
    1.  **Homography Estimation and RANSAC .** Implement RANSAC to 
    ...
    1.  **Image Warping.** Warp one image onto the other using the 
...
1.  **Fundamental Matrix Estimation, Camera Calibration, Triangulation 
   .** The goal of this assignment is to implement fundamental matrix
    ...
    **Test Images:** We are providing two image pairs, [library](./Q2/) and 
    ...
    1.  **Fundamental Matrix Estimation .** Given point matches, your task
    ...
    1.  **Camera Centers .** Calculate the camera centers using the 
    ...
    1.  **Triangulation .** Use linear least squares to triangulate the
    ...
    1.  **Extra Credits .** Use your putative match generation and RANSAC
...
1.  **Single-View Geometry.** The goal of this assignment is to 
    ...
    **Test Images:** We are providing starter code [here](Q3/Q3_starter.ipynb), and an
    ...
    1.  **Vanishing Points .** Estimate the three major orthogonal 
    ...
    1.  **Horizon .** Estimate the horizon, using the vanishing points 
    ...
    1.  **Camera Calibration .** Using the fact that the vanishing 
        ...
        you find.
    1.  **Rotation Matrix .** Compute and report the rotation matrix for
        the camera.
    1.  **Extra Credits .** 
